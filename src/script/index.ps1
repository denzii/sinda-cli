...
function Enable-WSL {
    try {
        ...
        Write-Host "This may require a restart to be able to login to the new Ubuntu distro."
    } catch {
        Write-Host "wsl --install not supported on this machine, falling back to the legacy install"
        Enable-WSLLegacy
    }
    try{
